...
Apesar disso, o HTTP/1.1 apresenta limitações de desempenho, como o problema de bloqueio de início de linha (Head-of-Line Blocking) e overhead de conexão. Além disso, existem poucas avaliações empíricas acessíveis que comparem o desempenho do HTTP/3 (baseado em QUIC) com o HTTP/1.1 em cenários de rede com perda de pacotes, dificultando decisões de migração.
### 2. Proposta
